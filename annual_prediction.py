# -*- coding: utf-8 -*-
"""annual_prediction.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1nAdPBCGhkpBwhSSrqTiN07QOwaI-gxxa
"""
...
def forecast_annually():
    ...
    xgb_mape = mean_absolute_percentage_error(y_dev, xgb_prediction)
    xgb_rmse = mean_squared_error(y_dev, xgb_prediction)
    ...
    poly_mape = mean_absolute_percentage_error(y_dev, poly_prediction)
    poly_rmse = mean_squared_error(y_dev, poly_prediction)
    ...
    """Original Values"""
    split_df['sales'] = np.ceil(split_df['sales']).astype(int)
    monthly_df = split_df.groupby(['year'], as_index=False)['sales'].sum()
